...
public class editprofileactivity extends AppCompatActivity {
    ...
    Button submit;
    TextInputLayout block_name, customSpinnerLayout;
    AutoCompleteTextView customTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        college_db.child("colleges").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot areaSnapshot: dataSnapshot.getChildren()) {
                    String areaName = areaSnapshot.child("college_name").getValue(String.class);
                    collegenames_list.add(areaName);
                }

                Toast.makeText(editprofileactivity.this, ""+collegenames_list, Toast.LENGTH_SHORT).show();
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String usn = usn_new.getText().toString();
